...
public class OpenAIGptClient implements AIClient {
    ...
    private MovieRecommendations movieRecommendations;

    public OpenAIGptClient(
            @Qualifier("openAIChatCompletionService")ChatCompletionService chatCompletionService,
    ...
    public List<ChatResponse> getChatResponse(String prompt){
        ...
        KernelFunctionArguments arguments = KernelFunctionArguments.builder()
                .withVariable("sources", movieRecommendations.getRecommendations(prompt))
        ...
        log.info("OpenAI Chat Response: {}", responses);
        return responses;
    }
